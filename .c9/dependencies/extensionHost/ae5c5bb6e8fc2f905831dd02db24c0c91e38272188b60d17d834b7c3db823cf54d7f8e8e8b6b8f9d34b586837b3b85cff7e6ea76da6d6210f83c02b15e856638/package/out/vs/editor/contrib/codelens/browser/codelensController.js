    ...
    let CodeLensContribution = class CodeLensContribution {
        constructor(_editor, _languageFeaturesService, debounceService, _commandService, _notificationService, _codeLensCache) {
            ...
            this._disposables.add(this._editor.onDidChangeConfiguration((e) => {
                if (e.hasChanged(44 /* EditorOption.fontInfo */) || e.hasChanged(16 /* EditorOption.codeLensFontSize */) || e.hasChanged(15 /* EditorOption.codeLensFontFamily */)) {
        ...
        _getLayoutInfo() {
            const lineHeightFactor = Math.max(1.3, this._editor.getOption(59 /* EditorOption.lineHeight */) / this._editor.getOption(46 /* EditorOption.fontSize */));
            let fontSize = this._editor.getOption(16 /* EditorOption.codeLensFontSize */);
            if (!fontSize || fontSize < 5) {
                fontSize = (this._editor.getOption(46 /* EditorOption.fontSize */) * .9) | 0;
            }
            return {
                fontSize,
        ...
        _updateLensStyle() {
            ...
            const editorFontInfo = this._editor.getOption(44 /* EditorOption.fontInfo */);
