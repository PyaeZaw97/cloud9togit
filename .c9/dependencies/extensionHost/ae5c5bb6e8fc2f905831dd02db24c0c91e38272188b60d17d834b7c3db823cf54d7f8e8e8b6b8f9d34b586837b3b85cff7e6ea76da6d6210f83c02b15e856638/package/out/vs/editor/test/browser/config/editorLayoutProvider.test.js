...
define(["require", "exports", "assert", "vs/editor/common/config/editorOptions", "vs/editor/browser/config/editorConfiguration"], function (require, exports, assert, editorOptions_1, editorConfiguration_1) {
    ...
    suite('Editor ViewLayout - EditorLayoutProvider', () => {
        function doTest(input, expected) {
            ...
            options._write(50 /* EditorOption.glyphMargin */, input.showGlyphMargin);
            options._write(61 /* EditorOption.lineNumbersMinChars */, input.lineNumbersMinChars);
            options._write(58 /* EditorOption.lineDecorationsWidth */, input.lineDecorationsWidth);
            options._write(37 /* EditorOption.folding */, false);
            ...
            options._write(65 /* EditorOption.minimap */, minimapOptions);
            ...
            options._write(92 /* EditorOption.scrollbar */, scrollbarOptions);
            const lineNumbersOptions = {
                renderType: input.showLineNumbers ? 1 /* RenderLineNumbersType.On */ : 0 /* RenderLineNumbersType.Off */,
                renderFn: null
            };
            options._write(60 /* EditorOption.lineNumbers */, lineNumbersOptions);
            options._write(118 /* EditorOption.wordWrap */, 'off');
            options._write(121 /* EditorOption.wordWrapColumn */, 80);
            options._write(122 /* EditorOption.wordWrapOverride1 */, 'inherit');
            options._write(123 /* EditorOption.wordWrapOverride2 */, 'inherit');
