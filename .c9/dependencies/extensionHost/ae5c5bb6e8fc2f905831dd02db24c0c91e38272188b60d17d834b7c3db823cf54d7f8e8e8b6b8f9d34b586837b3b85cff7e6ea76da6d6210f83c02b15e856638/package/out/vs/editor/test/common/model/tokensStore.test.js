 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "vs/editor/common/tokens/sparseMultilineTokens", "vs/editor/common/tokens/sparseTokensStore", "vs/editor/common/core/range", "vs/editor/common/core/position", "vs/editor/common/languages", "vs/editor/test/common/testTextModel", "vs/editor/common/tokens/lineTokens", "vs/editor/common/services/languagesRegistry", "vs/base/common/lifecycle", "vs/platform/instantiation/common/serviceCollection", "vs/editor/common/languages/languageConfigurationRegistry", "vs/platform/instantiation/common/descriptors"], function (require, exports, assert, sparseMultilineTokens_1, sparseTokensStore_1, range_1, position_1, languages_1, testTextModel_1, lineTokens_1, languagesRegistry_1, lifecycle_1, serviceCollection_1, languageConfigurationRegistry_1, descriptors_1) {
    "use strict";
        ...
        function extractState(model) {
            ...
            for (let lineNumber = 1; lineNumber <= model.getLineCount(); lineNumber++) {
                ...
                for (let i = 0; i < lineTokens.getCount(); i++) {
                    ...
                    const color = languages_1.TokenMetadata.getForeground(metadata);
