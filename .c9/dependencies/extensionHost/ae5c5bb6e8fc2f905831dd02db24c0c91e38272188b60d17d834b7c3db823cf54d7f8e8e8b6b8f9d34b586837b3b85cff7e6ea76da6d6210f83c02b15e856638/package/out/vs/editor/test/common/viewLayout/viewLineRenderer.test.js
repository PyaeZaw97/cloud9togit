...
define(["require", "exports", "assert", "vs/base/common/strings", "vs/editor/common/viewLayout/lineDecorations", "vs/editor/common/viewLayout/viewLineRenderer", "vs/editor/test/common/core/testLineToken"], function (require, exports, assert, strings, lineDecorations_1, viewLineRenderer_1, testLineToken_1) {
    ...
    suite('viewLineRenderer.renderLine', () => {
        ...
        test('overflow', () => {
            ...
            assertCharacterMapping3(_actual.characterMapping, [
                [0, [0, 0]],
                [1, [1, 0]],
                [2, [2, 0]],
                [3, [3, 0]],
        ...
        test('issue #91178: after decoration type shown before cursor', () => {
            ...
            const expectedCharacterMapping = new viewLineRenderer_1.CharacterMapping(17, 4);
        ...
        function decodeCharacterMapping(source) {
            const mapping = [];
        ...
        function assertCharacterMapping2(actual, expected) {
    ...
    suite('viewLineRenderer.renderLine 2', () => {
        function testCreateLineParts(fontIsMonospace, lineContent, tokens, fauxIndentLength, renderWhitespace, selections, expected) {
