define(["require", "exports", "assert", "vs/base/common/path", "vs/base/common/uri", "vs/platform/configuration/common/configurationModels", "vs/platform/configuration/common/configurationRegistry", "vs/platform/registry/common/platform", "vs/platform/workspace/common/workspace", "vs/platform/workspace/test/common/testWorkspace"], function (require, exports, assert, path_1, uri_1, configurationModels_1, configurationRegistry_1, platform_1, workspace_1, testWorkspace_1) {
    ...
    suite('CustomConfigurationModel', () => {
        ...
        test('Test registering the same property again', () => {
            ...
            assert.strictEqual(true, new configurationModels_1.DefaultConfigurationModel().getValue('a'));
        });
    });
    suite('CustomConfigurationModel', () => {
        ...
        test('Default configuration model uses overrides', () => {
            ...
            assert.strictEqual(false, new configurationModels_1.DefaultConfigurationModel({ a: false }).getValue('a'));
        });
    });
    suite('Configuration', () => {
        test('Test inspect for overrideIdentifiers', () => {
            ...
            const testObject = new configurationModels_1.Configuration(defaultConfigurationModel, userConfigurationModel, new configurationModels_1.ConfigurationModel(), workspaceConfigurationModel);
        ...
        test('Test compare and update default configuration', () => {
            const testObject = new configurationModels_1.Configuration(new configurationModels_1.ConfigurationModel(), new configurationModels_1.ConfigurationModel());
    ...
    suite('ConfigurationChangeEvent', () => {
        test('changeEvent affecting keys with new configuration', () => {
            const configuration = new configurationModels_1.Configuration(new configurationModels_1.ConfigurationModel(), new configurationModels_1.ConfigurationModel());
