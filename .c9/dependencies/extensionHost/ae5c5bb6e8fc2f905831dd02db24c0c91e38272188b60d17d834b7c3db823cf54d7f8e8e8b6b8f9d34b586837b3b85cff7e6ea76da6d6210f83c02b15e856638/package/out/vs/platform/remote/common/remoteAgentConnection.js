...
define(["require", "exports", "vs/base/common/async", "vs/base/common/buffer", "vs/base/common/cancellation", "vs/base/common/errors", "vs/base/common/event", "vs/base/common/lifecycle", "vs/base/common/uuid", "vs/base/parts/ipc/common/ipc.net", "vs/platform/remote/common/remoteAuthorityResolver"], function (require, exports, async_1, buffer_1, cancellation_1, errors_1, event_1, lifecycle_1, uuid_1, ipc_net_1, remoteAuthorityResolver_1) {
    ...
    function createSocket(logService, socketFactory, host, port, query, debugLabel, timeoutCancellationToken) {
        const result = new PromiseWithTimeout(timeoutCancellationToken);
        socketFactory.connect(host, port, query, debugLabel, (err, socket) => {
