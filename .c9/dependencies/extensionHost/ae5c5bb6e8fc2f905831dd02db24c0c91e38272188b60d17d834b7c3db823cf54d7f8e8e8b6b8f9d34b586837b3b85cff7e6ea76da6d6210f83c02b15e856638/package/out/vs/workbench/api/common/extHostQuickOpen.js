 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "vs/base/common/cancellation", "vs/base/common/event", "vs/base/common/lifecycle", "./extHost.protocol", "vs/base/common/uri", "vs/workbench/api/common/extHostTypes", "vs/base/common/errors", "vs/base/common/arrays", "vs/base/common/severity", "vs/platform/theme/common/themeService", "vs/workbench/services/extensions/common/extensions"], function (require, exports, cancellation_1, event_1, lifecycle_1, extHost_protocol_1, uri_1, extHostTypes_1, errors_1, arrays_1, severity_1, themeService_1, extensions_1) {
    "use strict";
    ...
    function createExtHostQuickOpen(mainContext, workspace, commands) {
        ...
        class ExtHostQuickOpenImpl {
            ...
            showInput(options, token = cancellation_1.CancellationToken.None) {
                ...
                this._validateInput = options ? (_a = options.validateInput2) !== null && _a !== void 0 ? _a : options.validateInput : undefined;
        ...
        class ExtHostInputBox extends ExtHostQuickInput {
            ...
            set validationMessage2(validationMessage) {
                var _a;
                (0, extensions_1.checkProposedApiEnabled)(this.extension, 'inputBoxSeverity');
