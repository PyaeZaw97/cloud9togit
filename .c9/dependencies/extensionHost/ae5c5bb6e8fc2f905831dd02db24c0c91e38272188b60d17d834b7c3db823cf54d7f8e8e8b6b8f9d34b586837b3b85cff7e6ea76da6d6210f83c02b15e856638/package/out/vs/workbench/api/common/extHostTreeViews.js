 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "vs/nls", "vs/base/common/resources", "vs/base/common/uri", "vs/base/common/event", "vs/base/common/lifecycle", "vs/base/common/async", "vs/workbench/api/common/extHostTypes", "vs/base/common/types", "vs/base/common/arrays", "vs/workbench/api/common/extHostTypeConverters", "vs/base/common/cancellation", "vs/workbench/api/common/shared/dataTransfer", "vs/workbench/services/views/common/treeViewsService", "vs/workbench/services/extensions/common/extensions"], function (require, exports, nls_1, resources_1, uri_1, event_1, lifecycle_1, async_1, extHostTypes_1, types_1, arrays_1, extHostTypeConverters_1, cancellation_1, dataTransfer_1, treeViewsService_1, extensions_1) {
    "use strict";
    ...
    class ExtHostTreeViews {
        ...
        async $handleDrop(destinationViewId, treeDataTransferDTO, targetItemHandle, token, operationUuid, sourceViewId, sourceTreeItemHandles) {
            ...
            const treeDataTransfer = dataTransfer_1.DataTransferConverter.toDataTransfer(treeDataTransferDTO);
        ...
        async $handleDrag(sourceViewId, sourceTreeItemHandles, operationUuid, token) {
            ...
            return dataTransfer_1.DataTransferConverter.toDataTransferDTO(treeDataTransfer);
        }
