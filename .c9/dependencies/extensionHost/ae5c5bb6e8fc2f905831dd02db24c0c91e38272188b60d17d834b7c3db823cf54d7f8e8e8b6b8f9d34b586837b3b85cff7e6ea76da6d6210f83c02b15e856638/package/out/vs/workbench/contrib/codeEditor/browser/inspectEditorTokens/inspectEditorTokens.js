...
define(["require", "exports", "vs/nls", "vs/base/browser/dom", "vs/base/common/color", "vs/base/common/lifecycle", "vs/editor/browser/editorExtensions", "vs/editor/common/core/range", "vs/editor/common/languages", "vs/editor/common/languages/language", "vs/platform/notification/common/notification", "vs/platform/theme/common/colorRegistry", "vs/platform/theme/common/themeService", "vs/workbench/services/textMate/common/TMHelper", "vs/workbench/services/textMate/browser/textMate", "vs/workbench/services/themes/common/workbenchThemeService", "vs/base/common/cancellation", "vs/platform/theme/common/tokenClassificationRegistry", "vs/platform/configuration/common/configuration", "vs/editor/common/services/modelService", "vs/platform/theme/common/theme", "vs/base/common/network", "vs/editor/common/services/languageFeatures", "vs/css!./inspectEditorTokens"], function (require, exports, nls, dom, color_1, lifecycle_1, editorExtensions_1, range_1, languages_1, language_1, notification_1, colorRegistry_1, themeService_1, TMHelper_1, textMate_1, workbenchThemeService_1, cancellation_1, tokenClassificationRegistry_1, configuration_1, modelService_1, theme_1, network_1, languageFeatures_1) {
    ...
    class InspectEditorTokensWidget extends lifecycle_1.Disposable {
        ...
        _decodeMetadata(metadata) {
            ...
            let languageId = languages_1.TokenMetadata.getLanguageId(metadata);
            let tokenType = languages_1.TokenMetadata.getTokenType(metadata);
            let fontStyle = languages_1.TokenMetadata.getFontStyle(metadata);
            let foreground = languages_1.TokenMetadata.getForeground(metadata);
            let background = languages_1.TokenMetadata.getBackground(metadata);
            return {
