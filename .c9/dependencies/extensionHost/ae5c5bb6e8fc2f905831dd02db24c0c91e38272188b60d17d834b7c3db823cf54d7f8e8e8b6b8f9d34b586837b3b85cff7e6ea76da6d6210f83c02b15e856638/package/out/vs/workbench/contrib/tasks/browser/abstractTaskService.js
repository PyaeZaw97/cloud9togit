...
define(["require", "exports", "vs/nls", "vs/base/common/severity", "vs/base/common/objects", "vs/base/common/resources", "vs/base/common/json", "vs/base/common/uri", "vs/base/common/actions", "vs/base/common/lifecycle", "vs/base/common/event", "vs/base/common/types", "vs/base/common/parsers", "vs/base/common/uuid", "vs/base/common/platform", "vs/base/common/map", "vs/platform/markers/common/markers", "vs/platform/telemetry/common/telemetry", "vs/platform/configuration/common/configuration", "vs/platform/files/common/files", "vs/workbench/services/extensions/common/extensions", "vs/platform/commands/common/commands", "vs/workbench/contrib/tasks/common/problemMatcher", "vs/platform/storage/common/storage", "vs/platform/progress/common/progress", "vs/platform/opener/common/opener", "vs/platform/notification/common/notification", "vs/platform/dialogs/common/dialogs", "vs/editor/common/services/model", "vs/workbench/contrib/markers/browser/constants", "vs/workbench/services/editor/common/editorService", "vs/workbench/services/configurationResolver/common/configurationResolver", "vs/platform/workspace/common/workspace", "vs/workbench/services/textfile/common/textfiles", "vs/workbench/services/output/common/output", "vs/workbench/contrib/terminal/browser/terminal", "vs/workbench/contrib/terminal/common/terminal", "vs/workbench/contrib/tasks/common/taskSystem", "vs/workbench/contrib/tasks/common/tasks", "vs/workbench/contrib/tasks/common/taskService", "vs/workbench/contrib/tasks/common/taskTemplates", "../common/taskConfiguration", "./terminalTaskSystem", "vs/platform/quickinput/common/quickInput", "vs/workbench/contrib/tasks/common/taskDefinitionRegistry", "vs/platform/contextkey/common/contextkey", "vs/workbench/contrib/tasks/browser/runAutomaticTasks", "vs/workbench/services/environment/common/environmentService", "vs/workbench/services/path/common/pathService", "vs/base/common/jsonFormatter", "vs/editor/common/services/resolverService", "vs/workbench/services/preferences/common/preferences", "vs/base/common/cancellation", "vs/workbench/common/views", "vs/workbench/contrib/tasks/browser/taskQuickPick", "vs/platform/log/common/log", "vs/base/common/functional", "vs/platform/theme/common/themeService", "vs/platform/workspace/common/workspaceTrust", "vs/workbench/common/contextkeys", "vs/base/common/network", "vs/workbench/services/panecomposite/browser/panecomposite"], function (require, exports, nls, severity_1, Objects, resources, json, uri_1, actions_1, lifecycle_1, event_1, Types, parsers_1, UUID, Platform, map_1, markers_1, telemetry_1, configuration_1, files_1, extensions_1, commands_1, problemMatcher_1, storage_1, progress_1, opener_1, notification_1, dialogs_1, model_1, constants_1, editorService_1, configurationResolver_1, workspace_1, textfiles_1, output_1, terminal_1, terminal_2, taskSystem_1, tasks_1, taskService_1, taskTemplates_1, TaskConfig, terminalTaskSystem_1, quickInput_1, taskDefinitionRegistry_1, contextkey_1, runAutomaticTasks_1, environmentService_1, pathService_1, jsonFormatter_1, resolverService_1, preferences_1, cancellation_1, views_1, taskQuickPick_1, log_1, functional_1, themeService_1, workspaceTrust_1, contextkeys_1, network_1, panecomposite_1) {
    ...
    let AbstractTaskService = class AbstractTaskService extends lifecycle_1.Disposable {
        ...
        registerTaskSystem(key, info) {
            if (!this._taskSystemInfos.has(key) || info.platform !== 0 /* Platform.Platform.Web */) {
        ...
        async getTask(folder, identifier, compareId = false) {
            ...
            const matchedTasks = await this._findWorkspaceTasks((task, workspaceFolder) => {
                ...
                if (taskFolder !== requestedFolder && taskFolder !== taskService_1.USER_TASKS_GROUP_KEY) {
                    return false;
                }
        ...
        createTerminalTaskSystem() {
            return new terminalTaskSystem_1.TerminalTaskSystem(this.terminalService, this.terminalGroupService, this.outputService, this.paneCompositeService, this.viewsService, this.markerService, this.modelService, this.configurationResolverService, this.telemetryService, this.contextService, this.environmentService, AbstractTaskService.OutputChannelId, this.fileService, this.terminalProfileResolverService, this.pathService, this.viewDescriptorService, this.logService, this.configurationService, this.notificationService, this, (workspaceFolder) => {
                if (workspaceFolder) {
        ...
        splitPerGroupType(tasks) {
            ...
            let defaults = [];
            for (let task of tasks) {
                if (task.configurationProperties.group.isDefault) {
                    defaults.push(task);
                }
                else {
                    none.push(task);
        ...
        runBuildCommand() {
            ...
            let promise = (async () => {
                const buildTasks = await this._findWorkspaceTasksInGroup(tasks_1.TaskGroup.Build, false);
                async function runSingleBuildTask(task, problemMatcherOptions, that) {
                ...
                if (buildTasks.length === 1) {
                    ...
                    if (tasks_1.ConfiguringTask.is(buildTask)) {
        ...
        runTestCommand() {
            ...
            let promise = this.getTasksForGroup(tasks_1.TaskGroup.Test).then((tasks) => {
                if (tasks.length > 0) {
                    let { none, defaults } = this.splitPerGroupType(tasks);
                    if (defaults.length === 1) {
                        this.run(defaults[0], undefined, 1 /* TaskRunSource.User */).then(undefined, reason => {
                            // eat the error, it has already been surfaced to the user and we don't care about it here
                        });
                        return;
                    }
                ...
                this.showIgnoredFoldersMessage().then(() => {
                    this.showQuickPick(tasks, nls.localize('TaskService.pickTestTask', 'Select the test task to run'), {
                        ...
                        this.run(task, undefined, 1 /* TaskRunSource.User */).then(undefined, reason => {
                            // eat the error, it has already been surfaced to the user and we don't care about it here
                        });
                    });
                });
        ...
        async runConfigureTasks() {
            ...
            let entries = Promise.all(stats).then((stats) => {
                return taskPromise.then((taskMap) => {
                    ...
                    if (needsCreateOrOpen || (taskMap.get(taskService_1.USER_TASKS_GROUP_KEY).length === configuredCount)) {
