...
define(["require", "exports", "vs/nls", "vs/base/common/objects", "vs/base/common/types", "vs/base/common/uuid", "vs/workbench/contrib/tasks/common/problemMatcher", "./tasks", "./taskDefinitionRegistry", "vs/workbench/contrib/tasks/common/taskService"], function (require, exports, nls, Objects, Types, UUID, problemMatcher_1, Tasks, taskDefinitionRegistry_1, taskService_1) {
    ...
    exports.createCustomTask = exports.parse = exports.TaskConfigSource = exports.JsonSchemaVersion = exports.ExecutionEngine = exports.GroupKind = exports.RunOptions = exports.RunOnOptions = exports.CommandString = exports.TaskIdentifier = exports.ShellQuoting = void 0;
    var ShellQuoting;
    ...
    (function (TaskParser) {
        ...
        function from(externals, globals, context, source) {
            ...
            for (let index = 0; index < externals.length; index++) {
                ...
                const definition = external.type ? taskDefinitionRegistry_1.TaskDefinitionRegistry.get(external.type) : undefined;
            ...
            const defaultBuildGroupName = Types.isString((_a = defaultBuildTask.task) === null || _a === void 0 ? void 0 : _a.configurationProperties.group) ? (_b = defaultBuildTask.task) === null || _b === void 0 ? void 0 : _b.configurationProperties.group : (_d = (_c = defaultBuildTask.task) === null || _c === void 0 ? void 0 : _c.configurationProperties.group) === null || _d === void 0 ? void 0 : _d._id;
            const defaultTestTaskGroupName = Types.isString((_e = defaultTestTask.task) === null || _e === void 0 ? void 0 : _e.configurationProperties.group) ? (_f = defaultTestTask.task) === null || _f === void 0 ? void 0 : _f.configurationProperties.group : (_h = (_g = defaultTestTask.task) === null || _g === void 0 ? void 0 : _g.configurationProperties.group) === null || _h === void 0 ? void 0 : _h._id;
