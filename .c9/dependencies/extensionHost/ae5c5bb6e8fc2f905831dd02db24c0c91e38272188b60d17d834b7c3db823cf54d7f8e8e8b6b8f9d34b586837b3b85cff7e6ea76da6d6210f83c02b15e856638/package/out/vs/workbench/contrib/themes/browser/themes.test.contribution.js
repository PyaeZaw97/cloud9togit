...
define(["require", "exports", "vs/base/common/uri", "vs/editor/common/languages/language", "vs/platform/commands/common/commands", "vs/platform/instantiation/common/instantiation", "vs/workbench/services/themes/common/workbenchThemeService", "vs/workbench/services/editor/common/editorService", "vs/workbench/common/editor", "vs/workbench/services/textMate/browser/textMate", "vs/editor/common/languages", "vs/workbench/services/textMate/common/TMHelper", "vs/base/common/color", "vs/platform/files/common/files", "vs/base/common/resources", "vs/base/common/network", "vs/base/common/strings"], function (require, exports, uri_1, language_1, commands_1, instantiation_1, workbenchThemeService_1, editorService_1, editor_1, textMate_1, languages_1, TMHelper_1, color_1, files_1, resources_1, network_1, strings_1) {
    "use strict";
        ...
        _themedTokenize(grammar, lines) {
            ...
            for (let i = 0, len = lines.length; i < len; i++) {
                ...
                for (let j = 0, lenJ = tokenizationResult.tokens.length >>> 1; j < lenJ; j++) {
                    ...
                    let color = languages_1.TokenMetadata.getForeground(metadata);
                    result[resultLen++] = {
                        text: tokenText,
