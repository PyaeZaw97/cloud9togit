    ...
    class DefaultConfiguration extends lifecycle_1.Disposable {
        ...
        get configurationModel() {
            if (!this._configurationModel) {
                this._configurationModel = new configurationModels_1.DefaultConfigurationModel(this.cachedConfigurationDefaultsOverrides);
            }
